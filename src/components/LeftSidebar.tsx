...
const LeftSidebar = () => {
  ...
  return (
    <div className={`${!show ? 'h-16' : ''} flex flex-col w-full md:w-40 xl:w-64 text-white bg-main-primary dark-mode:text-gray-200 dark-mode:bg-gray-800 flex-shrink`}>
      <div onClick={toggleShow}  className="flex-shrink-0 px-8 py-4 flex flex-row items-center justify-between bg-main-primary z-20">
        <a href="#" onClick={toggleShow}  className="text-lg font-semibold tracking-widest text-white uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">
          SQL Web Editor
        </a>
